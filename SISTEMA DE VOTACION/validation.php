...
$sql_est = "SELECT nombre, total_votos FROM candidatos_est WHERE carrera = 'Ingeniería de Software'";
$result_est = mysqli_query($conexion, $sql_est);

// Consultar otros candidatos de la tabla `candidatos_prof`
$sql_prof = "SELECT nombre, total_votos FROM candidatos_prof WHERE carrera = 'Ingeniería de Software'";
...
<head>
    ...
    <title>Resultados de Candidatos - Ingenieria de Software</title>
...
<div class="container">
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="card-5">
                <h2><strong>Resultados de Estudiantes de Ingeniería de Software</strong></h2>
                <hr>
            ...
            <div class="card-5">
                <h2><strong>Resultados de Docentes de Ingenieria de Software</strong></h2>
                <hr>
