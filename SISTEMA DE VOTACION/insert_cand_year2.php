...
<body>
    <div class="container">
        <div class="row">
            <div class="col-md-12">
            <a href="listado_candidato1.php"><button style="margin-top:80px;" class="btn-special-2">Estudiantes</button></a>
            </div>
            <div class="col-md-12">
            <a href="listado_candidato2.php"><button style="margin-top:80px;" class="btn-special-2">Docentes</button></a>
            </div>
        </div>
    </div>
