...
if ($candidato_id > 0) {
    ...
    echo "<script>alert('Gracias por tu voto!'); window.location='estudiante_ambiental.php';</script>";
} else {
    echo "<script>alert('Candidato no válido.'); window.location='estudiante_ambiental';</script>";
}
